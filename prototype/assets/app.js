...
/* ------------------------------------------------------------------ *
 * Mount. The class above is the design file's logic, unchanged.
 * ------------------------------------------------------------------ */
document.addEventListener("DOMContentLoaded", function () {
  window.scm = DCRuntime.mount(
    document.getElementById("scm-template"),
    document.getElementById("scm-root"),
    new Component({})
  );
});
